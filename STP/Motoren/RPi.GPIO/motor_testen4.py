...
GPIO.setup(11, GPIO.OUT) # GPIO 25 is set to be an output.

pwm = GPIO.PWM(11, 50)   # pwm is an object. This gives a neat way to control the pin.
                         # 11 is the BCM pin number.
                         # 50 is the frequency in Hz.
